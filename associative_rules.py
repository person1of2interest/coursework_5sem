...
DATA_PATH = './' #путь до папки с файлами
...
#запускаем на наших данных (первые 10000 строк, чтобы время ожидания было разумным)
transactions = transactions_main.iloc[:10000]
...
#пример применения для пользователя 240316 из transactions_dict (словарь для первых 10000 строк)
recs_list = []
